...
export default function DashboardPage() {
  ...
  const stats = [
    { title: 'Active Jobs', value: user.completedJobs ? '3' : '0', color: 'bg-blue-500' },
    { title: 'Completed Jobs', value: user.completedJobs?.toString() || '0', color: 'bg-green-500' },
    { title: 'Rating', value: user.rating ? `${user.rating}/5` : 'N/A', color: 'bg-yellow-500' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">RepairMen Dashboard</h1>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              >
                <div className="font-medium text-blue-900">View Service Requests</div>
                <div className="text-sm text-blue-700">Manage incoming job requests</div>
              </Link>
              <Link
                href="/schedule"
                className="block w-full text-left px-4 py-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors"
              >
                <div className="font-medium text-green-900">Manage Schedule</div>
                <div className="text-sm text-green-700">Set your availability</div>
              </Link>
              <Link
                href="/profile"
              ...
              >
                ...
                <div className="text-sm text-purple-700">Edit specialties and rates</div>
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <p className="text-sm text-gray-600">Plumbing repair - Kitchen sink</p>
              ...
              <div className="border-l-4 border-yellow-500 pl-4">
                ...
                <p className="text-sm text-gray-600">$150 for bathroom repair</p>
